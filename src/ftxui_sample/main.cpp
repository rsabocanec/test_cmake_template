...
// configuration step. It creates a namespace called `test_cmake_template`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", test_cmake_template::cmake::project_name, test_cmake_template::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", test_cmake_template::cmake::project_version);
      return EXIT_SUCCESS;
    }
